...
class HandTrackingGUI(QMainWindow):
    def __init__(self):
        ...
        self.table.setFixedHeight(200)  # Set a fixed height for the table
        right_layout.addWidget(self.table)

        # Add some vertical spacing
        right_layout.addSpacing(20)

        # Calibration status with bigger font
        ...
        # Add stretch to push calibration label to the bottom
